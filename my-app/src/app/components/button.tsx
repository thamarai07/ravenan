...
export default function Button(props: ButtonInterface) {
  ...
  return(
    <>
    {buttonutils.map((value)=>(
        (value.variant === props.variant &&  <button key={value.id} className={value.variant === props.variant ? value.className + props.className  : ""} onClick={props.onClick}>{props.content}</button> )
    )) }
    </>
  )
}
